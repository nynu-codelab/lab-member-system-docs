...
(name, student_no, gender, grade, major, department, position, profile_status, phone, email, status)
VALUES
('张三', '20230001', 1, '2023', '软件工程', 'SOFTWARE', 'BACKEND', 'COMPLETED', '13800138001', 'zhangsan@example.com', 1),
('李四', '20230002', 2, '2023', '计算机科学与技术', 'SOFTWARE', 'FRONTEND', 'COMPLETED', '13800138002', 'lisi@example.com', 1),
('王五', '20240001', 1, '2024', '人工智能', 'SOFTWARE', 'FULLSTACK', 'COMPLETED', '13800138003', 'wangwu@example.com', 1),
