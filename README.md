...
> 仓库版本 V1.2 ｜ 题目文档版本：需求 V1.2 / 数据库 V1.1 / 接口 V1.1 / 测试用例 V1.2
...
| department | `ACHIEVEMENT` | 成果中心（承载成果归档、竞赛、论文、专利、软著与企业合作职位） |
| position | `CAPTAIN` | 队长 |
...
**动手前**：先读 [docs 仓库](https://github.com/nynu-codelab/docs) 的 `software/` 规范（Git 协作、GitHub 协作、工程规范），再读本仓库题目文档。本仓库维护类改动走「分支 + PR + `codelab-admin` 批准」，审批线见 `CODEOWNERS`。
